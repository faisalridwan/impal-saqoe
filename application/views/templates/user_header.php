...
<head>
    ...
    <link rel="icon" href="<?=base_url()?>/logotok.png" type="image/png">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="<?= base_url('user'); ?>">
                <i class=""><img src="<?= base_url('assets/'); ?>img/logotok.png" alt="" width="50%" height="50%"></i>
                <div class="sidebar-brand-text" style="padding-right: 30px;">Saqoe</div>
            </a>
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#harian">
            ...
            <li class="nav-item">
                ...
                <div id="event" class="collapse" aria-labelledby="headingUtilities">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="#TambahEvent" data-toggle="modal" data-target="#TambahEvent">Tambah Event</a>
                        <a class="collapse-item" href="#EventPemasukan" data-toggle="modal" data-target="#EventPemasukan">Pemasukan</a>
                        <a class="collapse-item" href="#EventPengeluaran" data-toggle="modal" data-target="#EventPengeluaran">Pengeluaran</a>
            ...
            <li class="nav-item">
                ...
                <div id="history" class="collapse" aria-labelledby="headingUtilities">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <!-- <h6 class="collapse-header">Custom Utilities:</h6> -->
